...
/// @nodoc
class _$StoriesFailureTearOff {
  const _$StoriesFailureTearOff();
...
/// @nodoc
const $StoriesFailure = _$StoriesFailureTearOff();
...
mixin _$StoriesFailure {
  ...
  @JsonKey(ignore: true)
  $StoriesFailureCopyWith<StoriesFailure> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $StoriesFailureCopyWith<$Res> {
  factory $StoriesFailureCopyWith(
          StoriesFailure value, $Res Function(StoriesFailure) then) =
      _$StoriesFailureCopyWithImpl<$Res>;
  $Res call({String error});
}

/// @nodoc
class _$StoriesFailureCopyWithImpl<$Res>
    implements $StoriesFailureCopyWith<$Res> {
  _$StoriesFailureCopyWithImpl(this._value, this._then);

  final StoriesFailure _value;
  // ignore: unused_field
  final $Res Function(StoriesFailure) _then;
...
/// @nodoc
class _$CustomErrorCopyWithImpl<$Res> extends _$StoriesFailureCopyWithImpl<$Res>
...
class _$CustomError implements CustomError {
  ...
  @override
  String toString() {
    return 'StoriesFailure.customError(error: $error)';
  }
...
abstract class CustomError implements StoriesFailure {
