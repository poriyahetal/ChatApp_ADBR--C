...
class CallsNotificationVibrationDurationDialog extends StatefulWidget {
  const CallsNotificationVibrationDurationDialog(
  ...
  @override
  _CallsNotificationVibrationDurationDialogState createState() =>
      _CallsNotificationVibrationDurationDialogState();
}

class _CallsNotificationVibrationDurationDialogState
    extends State<CallsNotificationVibrationDurationDialog> {
  @override
