...
class ChatsNotificationVibrationDurationDialog extends StatefulWidget {
  const ChatsNotificationVibrationDurationDialog(
  ...
  @override
  _ChatsNotificationVibrationDurationDialogState createState() =>
      _ChatsNotificationVibrationDurationDialogState();
}

class _ChatsNotificationVibrationDurationDialogState
    extends State<ChatsNotificationVibrationDurationDialog> {
  @override
