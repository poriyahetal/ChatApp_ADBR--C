...
class ChatWallpaperViewPage extends StatefulWidget {
  const ChatWallpaperViewPage({Key? key}) : super(key: key);

  @override
  _ChatWallpaperViewPageState createState() => _ChatWallpaperViewPageState();
}

class _ChatWallpaperViewPageState extends State<ChatWallpaperViewPage> {
  String? imagePath;
  String bg = '';
  ...
  @override
  void didUpdateWidget(covariant ChatWallpaperViewPage oldWidget) {
    getBg();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBarTitle(
          title:
              context.read<SettingsBloc>().state.languageData.changeWallpaper),
